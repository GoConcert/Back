...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { capacity: @concert.capacity, date: @concert.date, description: @concert.description, image: @concert.image, location: @concert.location, price: @concert.price, title: @concert.title } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { capacity: @concert.capacity, date: @concert.date, description: @concert.description, image: @concert.image, location: @concert.location, price: @concert.price, title: @concert.title } }
